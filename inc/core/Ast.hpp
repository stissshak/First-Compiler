...
// defined before Expr: Expr holds a unique_ptr<Type>, whose destructor needs
// Type complete (a forward declaration is not enough under a strict frontend)
struct Type : Node {
...
enum class BuiltinTypes { Int, Float, Char, Void, Custom, Bool, Byte, Short, Long, UInt };
